...
def DataManager(bucket: str = None, d: DataHandler=None, fr: FeatureRecipe=None, fe: FeatureExtractor=None):
    ...
    fe = FeatureExtractor(d.df_merge, list(["local_price", "latitude","longitude", "pricing_weekly_factor", "pricing_monthly_factor", "person_capacity", "beds", "bedrooms", "bathrooms"]))
    fe.extract()
